...
This website is based on (http://getkirby.com)[Kirby] with the (https://github.com/sashtown/baseblog)[Baseblog theme]. I adapted the theme further to suit my purpose.

The comments section is powered by (https://disqus.com)[Disqus].

I would like to specifically mention the sharing buttons for Facebook, Twitter and Google+. These buttons use the (https://github.com/heiseonline/shariff)[Shariff] scripts, developed by the German IT magazine c't and integrated via (https://spicyhub.de/spicy-web/kirby-plugin-shariff)[a Kirby plugin]. These buttons allow sharing of content without the ugly tracking that usually comes along with it. Yes, you do get tracked on websites, even if you don't share any content. The pure existence of the button on the page is sufficient. For pages that do not use the beautiful Shariff buttons you can use plugins to disable tracking, e.g. Disconnect for the (https://chrome.google.com/webstore/detail/disconnect/jeoacafpbcihiomhlakheieifhpjdfeo?hl=en)[Chrome] or (https://addons.mozilla.org/en-us/firefox/addon/disconnect/)[Firefox] browsers.
