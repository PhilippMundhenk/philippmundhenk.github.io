...
Tags: home,raspberry,pi,mail server,tech
...
(l3: Mozilla Cipher Suites)
Up-to-date information on secure cipher suite settings are available from (link: https://wiki.mozilla.org/Security/Server_Side_TLS text: Mozilla popup:yes). You might want to use the (link: https://wiki.mozilla.org/Security/Server_Side_TLS#Modern_compatibility text: modern compatibility suites popup:yes) and fall back to (link: https://wiki.mozilla.org/Security/Server_Side_TLS#Intermediate_compatibility_.28default.29 text: intermediate popup:yes), if you experience compatibility issues.

I will try to keep this article as up-to-date as possible.

(l2: Installation)
I am torn about writing a full guide, but there is a guide just too good to ignore it and I used it as a basis for my setup also. It was written by Sam Hobbs and is available (link: https://samhobbs.co.uk/raspberry-pi-email-server text: here popup:yes). The blog of Sam Hobbs is generally a recommended read, also beyond the mail server article! I will refer to the post of Sam Hobbs to shorten things here and will explain some additional details I required. I suggest you follow his tutorial to set up a mail server, at least parts 1-3. The settings here can be added afterwards.
...
```
as well as a 2048-Bit Diffie-Hellman group. Details can be found (link: https://weakdh.org/sysadmin.html text: here popup:yes)
...
```
*Update 2015-05-21*: To address Logjam vulnerability, add a 2048-Bit Diffie-Hellman group. Details can be found (link: https://weakdh.org/sysadmin.html text: here popup:yes)
...
You can install Roundcube as described (link: http://trac.roundcube.net/wiki/Howto_Install text: here popup: yes)
...
You can check your setup with (link:https://www.ssllabs.com/ssltest/ text: Qualys SSL Labs popup:yes).
