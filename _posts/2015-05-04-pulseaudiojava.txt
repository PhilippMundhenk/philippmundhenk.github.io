...
Tags: work,TUM CREATE,EVA,Java,tech,PulseAudio
...
(l2: Download)
The code, detailed references and a demo application are available on (link: https://github.com/PhilippMundhenk/PulseAudioJava text: Github).