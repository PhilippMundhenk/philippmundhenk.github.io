...
(l2: References)
- (link: https://github.com/PhilippMundhenk/BrotherScannerDocker text: Brother Scanner Docker container popup:yes)
- (link: https://github.com/PhilippMundhenk/TesseractOCRMicroservice text: Tesseract OCR Microservice popup:yes)