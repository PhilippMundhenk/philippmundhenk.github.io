...
Tags: work,TUM CREATE,tech,Windows,Linux
...
To call the above scripts, you will require Plink. Plink is part of the Putty framework and allows to run SSH commands from the command line in Windows. You can find it (link: http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html text: here  popup:yes). Place the Plink.exe into any folder, but make sure to remember the name. We assume it is located in *C:\lock_scripts*.
