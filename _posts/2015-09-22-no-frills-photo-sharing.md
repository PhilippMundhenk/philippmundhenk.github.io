...
Tags: home,tech,PHP,JavaScript,photo sharing,photo collection
...
(l2: Installation)
Simply download from (link: https://github.com/PhilippMundhenk/NoFrillsPhotoSharing text: GitHub popup:yes) and place in a directory of your server.
That's it!
...
(l2: Screenshots)
(image: screenshot1.png caption: Login Screen)
(image: screenshot2.png caption: Main uploader with upload and download buttons and gallery)
...
(l2: Download)
As usual, the tool is open source and available on (link: https://github.com/PhilippMundhenk/NoFrillsPhotoSharing text: GitHub popup:yes). Feel free to use, comment, extend, enjoy!