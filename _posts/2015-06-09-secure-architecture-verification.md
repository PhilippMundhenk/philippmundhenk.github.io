...
Tags: work,TUM CREATE,verification,tech
...
Here you can find my (file: securearchitectureanalysis.pdf text: paper) and (file: presentation.pdf text: presentation), as presented on the 52nd Design Automation Conference (DAC) 2015 in San Francisco.