...
This website is based on (link: http://getkirby.com text: Kirby) with the (link: https://github.com/sashtown/baseblog text: Baseblog theme). I adapted the theme further to suit my purpose.

The comments section is powered by (link: https://disqus.com text: Disqus).

I would like to specifically mention the sharing buttons for Facebook, Twitter and Google+. These buttons use the (link: https://github.com/heiseonline/shariff text: Shariff) scripts, developed by the German IT magazine c't and integrated via (link: https://spicyhub.de/spicy-web/kirby-plugin-shariff text: a Kirby plugin). These buttons allow sharing of content without the ugly tracking that usually comes along with it. Yes, you do get tracked on websites, even if you don't share any content. The pure existence of the button on the page is sufficient. For pages that do not use the beautiful Shariff buttons you can use plugins to disable tracking, e.g. Disconnect for the (link: https://chrome.google.com/webstore/detail/disconnect/jeoacafpbcihiomhlakheieifhpjdfeo?hl=en text: Chrome) or (link: https://addons.mozilla.org/en-us/firefox/addon/disconnect/ text: Firefox) browsers.
